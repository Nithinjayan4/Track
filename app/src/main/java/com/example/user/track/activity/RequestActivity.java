...
import com.example.user.track.adapter.RequestListAdapter;
...
public class RequestActivity extends AppCompatActivity {
    ...
    String url="",ip="",uid="",url_imgpath="",name="",fid="",imgname="",rid="",status="";
    private RecyclerView RvItem;
    RequestListAdapter adapter=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://" + ip + "/navigation/get_requests.php";
    ...
    public  void showlist(String s){
        ...
        try{
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                RvItem = (RecyclerView) findViewById(R.id.recycler_request);
                ...
                adapter = new RequestListAdapter(RequestActivity.this, list,ip);
