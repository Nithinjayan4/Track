...
public class ShopListActivity extends AppCompatActivity {
    ...
    String url="",ip="",uid="",loc="",name="",sid="",imgname="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://" + ip + "/navigation/get_shops.php";
       // url_imgpath = "http://" + ip + "/navigation/images/";
        GetShops();
    }
        ...
        try{
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
              ...
              //  item.setImage_url(url1);
                ...
                RvItem = (RecyclerView) findViewById(R.id.recycler_shop);
                ...
                adapter = new ShopListAdapter(getApplicationContext(),list);
